...
class WS2812 {
public:
	WS2812(gpio_num_t gpioNum, uint16_t pixelCount, uint16_t lineCount,  int channel = RMT_CHANNEL_0);
	void show();
	...
	void add_wavelet(pixel_t color, float t, float freq, int length,float brightness = 1.0);
